...
2020年12月31日，北京市外办会同交通系统相关单位组织外语翻译、汉语拼音、导向标识、地名管理等领域的中外权威专家反复论证，最终确定了「北京市城市轨道交通站名英文译法」，在 2020 底发布的新版轨道交通线网图中率先应用，并逐步扩展至地铁全路网系统。
...
>     +    -> <ruby>文<rp>(</rp><rt>ying</rt><rp>)</rp></ruby>
>
> +   学校相关的变化
>
>     +   `一号线` Communication University of China -> <ruby>Chuanmei Daxue<rp>(</rp><rt>传媒大学</rt><rp>)</rp></ruby> (Communication Univ. of China)
>     +   East Gate of Peking University -> <ruby>Beijing Daxue Dongmen<rp>(</rp><rt>北京大学东门</rt><rp>)</rp></ruby> (Peking Univ. East Gate)
>     +   RENMIN University -> <ruby>Renmin Daxue<rp>(</rp><rt>人民大学</rt><rp>)</rp></ruby> (Renmin Univ.)
...
>     +   ANHEQIAO North -> <ruby>Anheqiaobei<rp>(</rp><rt>安河桥北</rt><rp>)</rp></ruby>
>     +   `四号线` `十号线` JIAOMEN West -> <ruby>Jiaomeng Xi (W)<rp>(</rp><rt>角门西</rt><rp>)</rp></ruby>
>     +   GAOMIDIAN North -> <ruby>Gaomidian Bei (N)<rp>(</rp><rt>高米店北</rt><rp>)</rp></ruby>
>     +   GAOMIDIAN South -> <ruby>Gaomidian Nan (S)<rp>(</rp><rt>高米店南</rt><rp>)</rp></ruby>
...
>     +   Beijing Railway Station -> <ruby>Beijing Zhan<rp>(</rp><rt>北京站</rt><rp>)</rp></ruby> (Beijing Railway Station)
>     +   YUANMINGYUAN Park -> <ruby>Yuanmingyuan<rp>(</rp><rt>圆明园</rt><rp>)</rp></ruby> (Yuanmingyuan Park)
>     +   `四号线` `九号线` `十六号线` National Library -> <ruby>Guojia Tushuguan<rp>(</rp><rt>国家图书馆</rt><rp>)</rp></ruby> (National Library)
>     +   Beijing Zoo -> <ruby>Dongwuyuan<rp>(</rp><rt>动物园</rt><rp>)</rp></ruby> (Beijing Zoo)
...
| 站名         | 2017                     | 2020   | 2022-01                                           | 2022-06                  |
| ------------ | ------------------------ | ------ | ------------------------------------------------- | ------------------------ |
| 新宫         | XIN'GONG                 | 无变化 | Xingong                                           | 无变化                   |
| 西红门       | XIHONGMEN                | 无变化 | Xihongmen                                         | Xihong Men               |
| 高米店北     | GAOMIDIAN North          | 无变化 | Gaomidianbei                                      | Gaomidian Bei (N)        |
| 高米店南     | GAOMIDIAN South          | 无变化 | Gaomidiannan                                      | Gaomidian Nan (S)        |
| 枣子园       | ZAOYUAN                  | 无变化 | Zhaoyuan                                          | 无变化                   |
| 清源路       | QINGYUANLU               | 无变化 | Qingyuan Lu                                       | 无变化                   |
| 黄村西大街   | HUANGCUNXIDAJIE          | 无变化 | Huangcun Xidajie                                  | 无变化                   |
| 黄村火车站   | HUANGCUN Railway Station | 无变化 | Huangcun Huochezhan<br>(HUANGCUN Railway Station) | HUANGCUN Railway Station |
| 义和庄       | YIHEZHUANG               | 无变化 | Yihezhuang                                        | 无变化                   |
| 生物医药基地 | Biomedical Base          | 无变化 | Shengwu Yiyao Jidi                                | Biomedical Base          |
| 天宫院       | TIAN'GONGYUAN            | 无变化 | Tiangongyuan                                      | Tiangong Yuan            |
