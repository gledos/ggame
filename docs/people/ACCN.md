...
> 正在攻击你们伺服器 看到请与我联系
>
> 伺服器~~(IP地址)~~正对此伺服器灌入大量流量 解除负责人与我联系
>
> 支付我们~~(价格)~~人民币 我们停止对你们旗下所有产品的攻击 包括日后发行的项目 收取一次性费用
>
> 如果你们有心处理让你们分次支付 也培养我们之间信任与信用 我们会先停止流量
>
> 今日支付~~(价格)~~ 剩余的看是要分一个月或是两个月支付完 都行
>
...
> 你好我们是Accn小组 正对你们游戏伺服器进行攻击 解除攻击请联系我们~~(未知信息)~~瘫痪伺服器~~(IP地址)~~請确认
...
时间: 2020-09-03 20:35
黑客的联系: 部分公布
是否给黑客汇款: 「对方以ACCN组织为名义，试图敲诈我公司的行为，我们绝不妥协！」
黑客的联系方式: QQ
黑客用户名: Attack
...
黑客的联系方式: QQ
黑客用户名: Accn
链接: [关于被黑客攻击的一些话 - KINGSENSE's General - TapTap KINGSENSE Group](https://archive.md/GbsyA "https://www.taptap.com/topic/18975434")
```
