...
随后韩国的玩家群体对此不满意，让此事件成为了导火索，让大量玩家联署要求国会废除「游戏物管理委员会」。[^cgrqw] 其中有玩家写了长文来论述审查机构和自由。[^Xyy9M]
...
2023年7月31日 14:00，《蔚蓝档案》在哔哩哔哩专栏和新浪微博发布了公告《〈蔚蓝档案〉美术资源调整说明》，[^DOpba] 调整了多个立绘，给出了补偿方案，但是没有给出原因。

下面是 8 个立绘修改对比，左边是国际服立绘，右边是大陆服：
...
2023年9月 下旬，网络上出现了《蔚蓝档案》简中服的反和谐方法，方法是修改游戏的一行配置文件，位于游戏目录中的 LocalizeConfig.txt 第三行，原始文件内容如下：
...
2023年10月26日，《蔚蓝档案》简中服上线了「夏日天空的愿望清单」活动，但是任务描述中使用了「击杀」，[^QwNwx] 这样不符合游戏内容，也不符合审查要求的措辞（太城市化了），一天后被修改为「击败」。
...
> +   调整个别非玩家可操作的剧情角色的立绘资源、调整个别成员的立绘资源（艾米、椿、菲娜、鹤城（泳装）、鹤城、花凛、堇、明日奈、琴里、瞬、真白、朱莉），调整后的立绘资源可见最下方。[^75529]
>
...
更新上线后，玩家发现之前一些未被修改的英文内容，被修改为了中文，比如「EX」->「绝技」[^02981]、「momofriends」->「桃桃朋友」，[^07176]「扫荡」功能似乎也被修改为了「快速战斗」。[^09545]
...
并且原本简中服需要 18 岁以上身份验证，才能游玩。[^CoMTJ] 但在此更新后，右下角新出现了「16+」的 [游戏适龄提示](/censorship/内容分级/游戏/游戏适龄提示.md)，[^17413] 尚不明确年龄要求是否有降低。
...
2023年11月9日，蔚蓝档案相关资料的第三方帐号，「碧蓝档案资讯站」表示自己的直播间被封禁，所以部分直播晚间的「国际服直播」资料。[^OkuDP]
