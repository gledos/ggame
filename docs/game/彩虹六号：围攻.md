...
最初的方法有两种，分别是小窗口以及使用其他游戏抬头显示器 (HUD) 覆盖：
...
2023年4月30日，R6SLAB (rainbow 6 stream lab) 开始将《彩虹六号：围攻》直播技术提升到了新的高度，这天 R6SLAB 发布了《一种基于光栅加密的彩虹六号直播方法》，[^187uq] 原理与《冒险小虎队》的解密卡相同，详细原理可以查看 [Image Obscuration within Moiré Pattern][] 等相关论文，这个方法的缺点是需要在客户端添加特殊的遮蔽条纹（光栅），内容也有较大损失。
