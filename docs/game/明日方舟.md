...
+   [x] 「夕」的英文名问题
+   [x] 谢拉格独立国家问题
+   [x] （7006737）：「二测期间，以隗研吾（某著名建筑师）为原型的角色“魏彦吾”手持晚清时期的大烟枪，三测被改为旱烟斗，
    ...
    +   gledos：经过搜索，大概知道了提出指控的作者的意思：
        1.  龙门执政者魏彦吾应该是谐音日本建筑师隈研吾，作者认为龙门（香港）的一号人物竟然是日本人，这是不对的。
        2.  魏彦吾手持晚清时期的大烟枪，作者认为这是不对的。而在三测期间被修改为旱烟斗，是好方向的改变，但之后又恢复了大烟枪。
...
并拥有多种藏地元素（佛教七宝、<ruby>铃杵<rt>圣铃</rt></ruby>、哈达）。所以「初雪」的原型被认为是西藏法王。[^54657]
...
谢拉格变成了世界各地雪山／山脉文化，并以瑞士为主，[^25746] 而不再像之前大量添加藏地元素。
